...
<div class="w3-content" style="max-width:1600px">
  ...
  <header class="w3-container w3-center w3-padding-48 w3-white">
    <h1 class="w3-xxxlarge"><b>Mary Help dos Santos  BLOGLIFE</b></h1>
    <h6>Welcome to the blog of <span class="w3-tag">Mary Help's world</span></h6>
  </header>
  ...
  <header class="w3-display-container w3-wide" id="home">
    ...
    <div class="w3-display-left w3-padding-large">
      <h1 class="w3-text-white">Mary's</h1>
    ...
    <div class="w3-col l8 s12">
      ...
      <div class="w3-container w3-white w3-margin w3-padding-large">
        ...
        <div class="w3-justify">
          <img src="https://www.w3schools.comhttps://www.w3schools.com/w3images/girl_hat.jpg" alt="Girl Hat" style="width:100%" class="w3-padding-16">
          ...
          <div class="w3-row w3-margin-bottom" id="demo1" style="display:none">
            <hr>
              <div class="w3-col l2 m3">
                <img src="https://www.w3schools.comhttps://www.w3schools.com/w3images/avatar_smoke.jpg" style="width:90px;">
              </div>
